...
public class MostrarGanadoresPremiosController {
	...
	public void mostrarGanadoresPremios() {
		...
		equipoSegundoMap.put("nombre", equipoSegundoTorneo.getNombre().trim());
		equipoSegundoMap.put("montoEquipo", String.valueOf(montoSegundo));
		equipoSegundoMap.put("montoJugador", String.valueOf(montoPorJugadorSegundo));
